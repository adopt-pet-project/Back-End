...
public class AdoptQueryService2 {
    private final JPAQueryFactory jpaQueryFactory;


    // 분양 게시글 리스트 조회
    public List<AdoptResponseDto2> selectAdoptList(Integer saleNo, String keyword, Integer option, String filter) {
        ...
        return jpaQueryFactory
                .select(Projections.constructor(AdoptResponseDto2.class,
                        adopt.saleNo,
                        adopt.title,
                        adopt.address,
